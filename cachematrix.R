...
# The following function returns the inverse of the matrix. It will check if the inverse has already been computed or not. 
...
# This function assumes that the matrix will be always invertible.
